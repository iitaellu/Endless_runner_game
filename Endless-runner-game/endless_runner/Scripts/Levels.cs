...
public partial class Levels : Node
{
	...
	[Signal]
	public delegate void LevelInfoFinishedEventHandler();

	private static Dictionary<string, string[]> _LEVEL_INFOS = new Dictionary<string, string[]>() {
		{"level1", new string [] {
	...
	public void ShowLevelInfo()
	{
		...
		_infoID = "level" + _levelnumber.ToString();
		getDialogy();
		//getDialogy("level" + _levelnumber.ToString());
